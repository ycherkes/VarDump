...
{
    private static readonly IObjectDescriptor PropertiesInfoProvider = new ObjectPropertiesDescriptor(BindingFlags.Public | BindingFlags.Instance, writablePropertiesOnly: false);
